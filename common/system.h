...
<<<<<<< HEAD
		...
		kTransactionFullscreenFailed = (1 << 2),	/**< Failed switching fullscreen mode */
		kTransactionModeSwitchFailed = (1 << 3),	/**< Failed switching the GFX graphics mode (setGraphicsMode) */
		kTransactionSizeChangeFailed = (1 << 4),	/**< Failed switching the screen dimensions (initSize) */
